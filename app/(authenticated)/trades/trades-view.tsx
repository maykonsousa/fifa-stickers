  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-4">
        <h2 className="text-sm font-semibold text-gray-900">Filtrar por localização</h2>
          ...
          {displayMatches.map((match) => (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-900">{match.display_name}</p>
                  {match.city && match.state && (
                    <p className="text-xs text-gray-500">{match.city}, {match.state}</p>
                  )}
                </div>
              </div>
